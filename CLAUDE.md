...
- Banks: A through J (10 banks), Pads: 1-12 per bank + 1 sub pad (pad 13)
- 130 total pad slots (13 per bank × 10 banks)
- Example: `G0000007.WAV` = Bank G, Pad 7
- Example: `A0000013.WAV` = Bank A, Sub Pad
...
**Pad convention** (13 pads per bank — 12 pads + 1 sub pad, SP-404A):
...
- Sub Pad (13): Wildcard — full beat loop, transition effect, or go-to sound
...
Generated by `scripts/gen_padinfo.py` — auto-sets gate mode for pads 1-4, loop mode for pads 5-12, loop for sub pad (13).
...
- 13 pads per bank (12 pads + 1 sub pad, not 16)
